 ...
 * <p>
 * {@code OffsetDateTime}, {@link ZonedDateTimeJalali} and {@link Instant} all store an instant
...
public final class OffsetDateTimeJalali
     ...
     * </pre>
     * <p>
     * The classes {@link LocalDateJalali}, {@link LocalTime} and {@link ZoneOffset} implement
    ...
    public ZonedDateTimeJalali atZoneSameInstant(ZoneId zone) {
        return ZonedDateTimeJalali.ofInstant(dateTime, offset, zone);
    }
     ...
     * {@link ZonedDateTimeJalali#withLaterOffsetAtOverlap()} immediately after this method.
     * <p>
    ...
    public ZonedDateTimeJalali atZoneSimilarLocal(ZoneId zone) {
        return ZonedDateTimeJalali.ofLocal(dateTime, zone, offset);
    }
    ...
    public ZonedDateTimeJalali toZonedDateTime() {
        return ZonedDateTimeJalali.of(dateTime, offset);
    }
