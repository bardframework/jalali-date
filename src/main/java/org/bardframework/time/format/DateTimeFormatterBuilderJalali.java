...
public final class DateTimeFormatterBuilderJalali {
     ...
     * Length comparator.
     */
    static final Comparator<String> LENGTH_SORT = (str1, str2) -> str1.length() == str2.length() ? str1.compareTo(str2) : str1.length() - str2.length();
    /**
...
//        return lr.getJavaTimeDateTimePattern(convertStyle(timeStyle), convertStyle(dateStyle), chrono.getCalendarType());
    }
    ...
    static class PrefixTree {
        ...
        private boolean add0(String k, String v) {
            ...
            if (prefixLen < k.length()) {
                child.sibling = newNode(k.substring(prefixLen), v, null);
                value = null;
            } else {
                value = v;
            }
